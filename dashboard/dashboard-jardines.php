        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="card text-white bg-info">
                <div class="card-header">
                  <h4 class="card-title" id="titulo">Indicador Jardines</h4>
                </div>
            ...
            <div class="col-md-3">
              <div class="card text-white bg-info">
                <div class="card-header">
                  <h4 class="card-title">Metros Meta</h4>
                </div>
                <div class="card-body" style="display: inherit;">
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function(){
      ...
      $('#sub-oficina').change(function(){
        indicadores();
        mapaActividades();
        $.post( "datos/programas.php", { oficina: 'Jardines', sub: this.value } )
        .done(function( data ) {
          $('#programa').html(data);
        });
      });
    ...
    function indicadores() {
      ...
      $.getJSON('datos/dashboard/indicadores.php', parametros, function(data) {
        var asistencia =Math.round( (data['asistentes']*100 ) / data['meta'] );
    ...
    function mapaActividades(){
      ...
      $.getJSON('datos/dashboard/actividades.php', parametros, function(lugares) {
        ...
        for (var i = 0; i < lugares.length; i++) {
          ...
          if (lugares[i]['colonia'] == 'Carretera') {
            html +=   "<p><strong>Dirección: </strong> " + lugares[i]['direccion'] + ", Zona " + lugares[i]['zona'] + "</p>";
          } else {
...
function actividadesGeneral(){
  $.getJSON('datos/dashboard/actividades-grafica.php', {oficina: 'Jardines'}, function(data) {
